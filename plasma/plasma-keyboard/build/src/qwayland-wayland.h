...
namespace QtWayland {
    ...
    public:
        ...
        struct ::wl_callback *get_release();
    ...
    {
    public:
        wl_fixes(struct ::wl_registry *registry, uint32_t id, int version);
        wl_fixes(struct ::wl_fixes *object);
        wl_fixes();

        virtual ~wl_fixes();

        void init(struct ::wl_registry *registry, uint32_t id, int version);
        void init(struct ::wl_fixes *object);

        struct ::wl_fixes *object() { return m_wl_fixes; }
        const struct ::wl_fixes *object() const { return m_wl_fixes; }
        static wl_fixes *fromObject(struct ::wl_fixes *object);
        ...
        void destroy();
        void destroy_registry(struct ::wl_registry *registry);

    private:
        struct ::wl_fixes *m_wl_fixes;
    };
}
