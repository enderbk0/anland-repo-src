...
namespace QtWaylandServer {
    ...
    protected:
        ...
        virtual void compositor_release(Resource *resource);
    ...
    public:
        ...
        enum format {
            ...
            format_rgb161616 = 0x38344752, // [47:0] R:G:B 16:16:16 little endian
            format_bgr161616 = 0x38344742, // [47:0] B:G:R 16:16:16 little endian
            format_r16f = 0x48202052, // [15:0] R 16 little endian
            format_gr1616f = 0x48205247, // [31:0] G:R 16:16 little endian
            format_bgr161616f = 0x48524742, // [47:0] B:G:R 16:16:16 little endian
            format_r32f = 0x46202052, // [31:0] R 32 little endian
            format_gr3232f = 0x46205247, // [63:0] R:G 32:32 little endian
            format_bgr323232f = 0x46524742, // [95:0] R:G:B 32:32:32 little endian
            format_abgr32323232f = 0x46384241, // [127:0] R:G:B:A 32:32:32:32 little endian
            format_nv20 = 0x3032564e, // 2x1 subsampled Cr:Cb plane
            format_nv30 = 0x3033564e, // non-subsampled Cr:Cb plane
            format_s010 = 0x30313053, // 2x2 subsampled Cb (1) and Cr (2) planes 10 bits per channel
            format_s210 = 0x30313253, // 2x1 subsampled Cb (1) and Cr (2) planes 10 bits per channel
            format_s410 = 0x30313453, // non-subsampled Cb (1) and Cr (2) planes 10 bits per channel
            format_s012 = 0x32313053, // 2x2 subsampled Cb (1) and Cr (2) planes 12 bits per channel
            format_s212 = 0x32313253, // 2x1 subsampled Cb (1) and Cr (2) planes 12 bits per channel
            format_s412 = 0x32313453, // non-subsampled Cb (1) and Cr (2) planes 12 bits per channel
            format_s016 = 0x36313053, // 2x2 subsampled Cb (1) and Cr (2) planes 16 bits per channel
            format_s216 = 0x36313253, // 2x1 subsampled Cb (1) and Cr (2) planes 16 bits per channel
            format_s416 = 0x36313453, // non-subsampled Cb (1) and Cr (2) planes 16 bits per channel
        };
    ...
    protected:
        ...
        virtual void shm_release(Resource *resource);
    ...
    protected:
        ...
        virtual void data_device_manager_release(Resource *resource);
    ...
    public:
        ...
        enum error {
            ...
            error_no_buffer = 5, // no buffer was attached
        };
    ...
    protected:
        ...
        virtual void surface_get_release(Resource *resource, uint32_t callback);
    ...
    private:
        ...
        static void handle_offset(
            ...
            int32_t x,
            int32_t y);
        static void handle_get_release(
            ::wl_client *client,
            struct wl_resource *resource,
            uint32_t callback);
    ...
    public:
        ...
        enum key_state {
            ...
            key_state_repeated = 2, // key was repeated
        };
    ...
    {
    public:
        wl_fixes(struct ::wl_client *client, uint32_t id, int version);
        wl_fixes(struct ::wl_display *display, int version);
        wl_fixes(struct ::wl_resource *resource);
        wl_fixes();
        ...
        {
        public:
            Resource() : fixes_object(nullptr), handle(nullptr) {}
            virtual ~Resource() {}

            wl_fixes *fixes_object;
            wl_fixes *object() { return fixes_object; } 
            struct ::wl_resource *handle;
    ...
    protected:
        virtual Resource *fixes_allocate();

        virtual void fixes_bind_resource(Resource *resource);
        virtual void fixes_destroy_resource(Resource *resource);

        virtual void fixes_destroy(Resource *resource);
        virtual void fixes_destroy_registry(Resource *resource, struct ::wl_resource *registry);
    ...
    private:
        ...
        static const struct ::wl_fixes_interface m_wl_fixes_interface;

        static void handle_destroy(
            ::wl_client *client,
            struct wl_resource *resource);
        static void handle_destroy_registry(
            ::wl_client *client,
            struct wl_resource *resource,
