...
#include "../../../../../../containments/homescreens/halcyon/windowlistener.h"
...
template <> constexpr inline auto WindowListener::qt_create_metaobjectdata<qt_meta_tag_ZN14WindowListenerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'windowCreated'
        QtMocHelpers::SlotData<void(KWayland::Client::PlasmaWindow *)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
    };
...
void WindowListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->windowChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->windowCreated((*reinterpret_cast<std::add_pointer_t<KWayland::Client::PlasmaWindow*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WindowListener::*)(QString )>(_a, &WindowListener::windowChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void WindowListener::windowChanged(QString _t1)
{
