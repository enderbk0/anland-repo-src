// /qt/qml/plasma/applet/org/kde/plasma/mobile/homescreen/folio/delegate/KeyboardHighlight.qml
...
namespace _qt_qml_plasma_applet_org_kde_plasma_mobile_homescreen_folio_delegate_KeyboardHighlight_qml {
...
0x94,0x6,0x0,0x0,0xc7,0xea,0x8c,0x73,
0x8e,0xc3,0xb2,0x3c,0xfc,0x77,0x9b,0x9f,
0x3c,0xcf,0xd1,0x9e,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x30,0x1,0x0,0x0,0x40,0x1,0x0,0x0,
0x70,0x1,0x0,0x0,0x24,0x1,0x0,0x0,
...
0x2e,0x4,0x3c,0x5,0x3c,0x6,0x3c,0x7,
0x18,0xa,0x2e,0x8,0x3c,0x9,0x3c,0xa,
0x3c,0xb,0x18,0xb,0x2e,0xc,0x3c,0xd,
0x3c,0xe,0x3c,0xf,0x18,0xc,0x14,0x1,
0xd,0xac,0x10,0x7,0x4,0xa,0x18,0x6,
...
aotContext->setInstructionPointer(4);
#endif
while (!aotContext->loadAttachedLookup(18, aotContext->qmlScopeObject, &s.v2_2)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(4);
#endif
aotContext->initLoadAttachedLookup(18, 4, aotContext->qmlScopeObject);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
...
aotContext->setInstructionPointer(6);
#endif
s.v2_4 = QVariant(aotContext->lookupResultMetaType(19));
while (!aotContext->getObjectLookup(19, s.v2_2, s.v2_4.data())) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(6);
#endif
