...
if (QT_MAJOR_VERSION EQUAL "6")
    ...
    # Get the qmldir file
    _ecm_qmlmodule_uri_to_path(MODULEDIR "org.kde.pipewire" "0.1")
    ...
    if (NOT MODULE_NOTFOUND AND NOT "0.1" STREQUAL "") # Check if we even need to check the version
        ...
        if (VERSION_FILE)
            ...
            if ("${FILE_CONTENTS}" MATCHES "([0-9]+(\\.[0-9]+)*)")
                if ("${CMAKE_MATCH_1}" VERSION_GREATER_EQUAL "0.1")
                    set(org.kde.pipewire-QMLModule_FOUND TRUE)
                endif()
                set(org.kde.pipewire-QMLModule_VERSION "${CMAKE_MATCH_1}")
            endif()
        else()
...
if (NOT CMAKE_CROSSCOMPILING AND NOT MODULE_NOTFOUND AND NOT org.kde.pipewire-QMLModule_FOUND AND (NOT DEFINED QT6_IS_SHARED_LIBS_BUILD OR QT6_IS_SHARED_LIBS_BUILD))
    if (QT_MAJOR_VERSION EQUAL "6")
    ...
    execute_process(COMMAND "${QMLPLUGINDUMP_PROGRAM}" "org.kde.pipewire" "0.1" ERROR_VARIABLE ERRORS_OUTPUT OUTPUT_VARIABLE DISREGARD_VARIABLE RESULT_VARIABLE ExitCode TIMEOUT 30)
    if(ExitCode EQUAL 0)
        set(org.kde.pipewire-QMLModule_FOUND TRUE)
    else()
        message(STATUS "qmlplugindump failed for org.kde.pipewire.")
        set(org.kde.pipewire-QMLModule_FOUND FALSE)
    endif()
endif()

set(org.kde.pipewire-QMLModule_FOUND ${org.kde.pipewire-QMLModule_FOUND} PARENT_SCOPE)
set(org.kde.pipewire-QMLModule_VERSION ${org.kde.pipewire-QMLModule_VERSION} PARENT_SCOPE)
find_package_handle_standard_args(org.kde.pipewire-QMLModule
    VERSION_VAR org.kde.pipewire-QMLModule_VERSION
    REQUIRED_VARS org.kde.pipewire-QMLModule_FOUND
    HANDLE_COMPONENTS
)
