...
. "/data/data/com.termux/files/usr/lib/libexec/plasma-dev-prefix.sh"
...
if [ -n "$XDG_RUNTIME_DIR" ]; then
    ...
    cp -r /data/data/com.termux/files/usr/lib/systemd/user/* "$XDG_RUNTIME_DIR"/systemd/user.control
