...
static void _CZwpTextInputV3SetAvailableActions(wl_client* client, wl_resource* resource, wl_array* available_actions) {
    const auto PO = (CZwpTextInputV3*)wl_resource_get_user_data(resource);
    if (PO && PO->requests.setAvailableActions)
        PO->requests.setAvailableActions(PO, available_actions);
}

static void _CZwpTextInputV3ShowInputPanel(wl_client* client, wl_resource* resource) {
    const auto PO = (CZwpTextInputV3*)wl_resource_get_user_data(resource);
    if (PO && PO->requests.showInputPanel)
        PO->requests.showInputPanel(PO);
}

static void _CZwpTextInputV3HideInputPanel(wl_client* client, wl_resource* resource) {
    const auto PO = (CZwpTextInputV3*)wl_resource_get_user_data(resource);
...
static const void* _CZwpTextInputV3VTable[] = {
    ...
    (void*)_CZwpTextInputV3SetAvailableActions,
    (void*)_CZwpTextInputV3ShowInputPanel,
    (void*)_CZwpTextInputV3HideInputPanel,
};
...
void CZwpTextInputV3::sendAction(zwpTextInputV3Action action, uint32_t serial) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 6, action, serial);
}

void CZwpTextInputV3::sendLanguage(const char* language) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 7, language);
}

void CZwpTextInputV3::sendPreeditHint(uint32_t start, uint32_t end, zwpTextInputV3PreeditHint hint) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 8, start, end, hint);
}
...
void CZwpTextInputV3::sendActionRaw(zwpTextInputV3Action action, uint32_t serial) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 6, action, serial);
}

void CZwpTextInputV3::sendLanguageRaw(const char* language) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 7, language);
}

void CZwpTextInputV3::sendPreeditHintRaw(uint32_t start, uint32_t end, zwpTextInputV3PreeditHint hint) {
    if (!pResource)
        return;
    wl_resource_post_event(pResource, 8, start, end, hint);
}
...
static const wl_interface* _CZwpTextInputV3SetAvailableActionsTypes[] = {
    nullptr,
};
...
static const wl_interface* _CZwpTextInputV3ActionTypes[] = {
    nullptr,
    nullptr,
};
static const wl_interface* _CZwpTextInputV3LanguageTypes[] = {
    nullptr,
};
static const wl_interface* _CZwpTextInputV3PreeditHintTypes[] = {
    nullptr,
    nullptr,
    nullptr,
};
...
static const wl_message _CZwpTextInputV3Requests[] = {
    ...
    { .name = "set_available_actions", .signature = "2a", .types = _CZwpTextInputV3SetAvailableActionsTypes + 0},
    { .name = "show_input_panel", .signature = "2", .types = textInputUnstableV3_dummyTypes + 0},
    { .name = "hide_input_panel", .signature = "2", .types = textInputUnstableV3_dummyTypes + 0},
};
...
static const wl_message _CZwpTextInputV3Events[] = {
    ...
    { .name = "action", .signature = "2uu", .types = _CZwpTextInputV3ActionTypes + 0},
    { .name = "language", .signature = "2s", .types = _CZwpTextInputV3LanguageTypes + 0},
    { .name = "preedit_hint", .signature = "2uuu", .types = _CZwpTextInputV3PreeditHintTypes + 0},
};

const wl_interface zwp_text_input_v3_interface = {
    .name = "zwp_text_input_v3", .version = 2,
    .method_count = 11, .methods = _CZwpTextInputV3Requests,
    .event_count = 9, .events = _CZwpTextInputV3Events,
};
...
void CZwpTextInputV3::setSetTextChangeCause(F<void(CZwpTextInputV3*, zwpTextInputV3ChangeCause)> &&handler) {
    requests.setTextChangeCause = std::move(handler);
}
...
void CZwpTextInputV3::setSetAvailableActions(F<void(CZwpTextInputV3*, wl_array*)> &&handler) {
    requests.setAvailableActions = std::move(handler);
}

void CZwpTextInputV3::setShowInputPanel(F<void(CZwpTextInputV3*)> &&handler) {
    requests.showInputPanel = std::move(handler);
}

void CZwpTextInputV3::setHideInputPanel(F<void(CZwpTextInputV3*)> &&handler) {
...
void CZwpTextInputManagerV3::setGetTextInput(F<void(CZwpTextInputManagerV3*, uint32_t, wl_resource*)> &&handler) {
    requests.getTextInput = std::move(handler);
}
