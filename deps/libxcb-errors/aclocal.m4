...
AC_PATH_TOOL(RAWCPP, [cpp], [${CPP}],
   [$PATH:/data/data/com.termux/files/usr/bin:/bin:/usr/bin:/usr/lib:/usr/libexec:/usr/ccs/lib:/usr/ccs/lbin:/lib])
...
AC_CACHE_CHECK([for m4 that supports -I option], [ac_cv_path_M4],
   ...
   [$PATH:/data/data/com.termux/files/usr/bin:/usr/gnu/bin])])
