...
static const struct static_extension_info_t extension_Dbe_info = { // DOUBLE-BUFFER
	.num_minor = 8,
	.strings_minor = "QueryVersion\0AllocateBackBuffer\0DeallocateBackBuffer\0SwapBuffers\0BeginIdiom\0EndIdiom\0GetVisualInfo\0GetBackBufferAttributes\0",
	.num_events = 0,
	.strings_events = NULL,
	.num_xge_events = 0,
	.strings_xge_events = NULL,
...
static const struct static_extension_info_t extension_DPMS_info = { // DPMS
	.num_minor = 9,
	.strings_minor = "GetVersion\0Capable\0GetTimeouts\0SetTimeouts\0Enable\0Disable\0ForceLevel\0Info\0SelectInput\0",
	.num_events = 0,
	.strings_events = NULL,
	.num_xge_events = 1,
...
static const struct static_extension_info_t extension_DRI3_info = { // DRI3
	.num_minor = 12,
	.strings_minor = "QueryVersion\0Open\0PixmapFromBuffer\0BufferFromPixmap\0FenceFromFD\0FDFromFence\0GetSupportedModifiers\0PixmapFromBuffers\0BuffersFromPixmap\0SetDRMDeviceInUse\0ImportSyncobj\0FreeSyncobj\0",
	.num_events = 0,
	.strings_events = NULL,
	.num_xge_events = 0,
	.strings_xge_events = NULL,
...
static const struct static_extension_info_t extension_Present_info = { // Present
	.num_minor = 6,
	.strings_minor = "QueryVersion\0Pixmap\0NotifyMSC\0SelectInput\0QueryCapabilities\0PixmapSynced\0",
	.num_events = 1,
...
int register_extensions(xcb_errors_context_t *ctx, xcb_connection_t *conn)
{
	...
	cookies[3] = xcb_query_extension_unchecked(conn, strlen("DOUBLE-BUFFER"), "DOUBLE-BUFFER");
	...
	cookies[7] = xcb_query_extension_unchecked(conn, strlen("Generic Event Extension"), "Generic Event Extension");
	cookies[8] = xcb_query_extension_unchecked(conn, strlen("GLX"), "GLX");
	cookies[9] = xcb_query_extension_unchecked(conn, strlen("Present"), "Present");
	cookies[10] = xcb_query_extension_unchecked(conn, strlen("RANDR"), "RANDR");
	cookies[11] = xcb_query_extension_unchecked(conn, strlen("RECORD"), "RECORD");
	cookies[12] = xcb_query_extension_unchecked(conn, strlen("RENDER"), "RENDER");
	cookies[13] = xcb_query_extension_unchecked(conn, strlen("X-Resource"), "X-Resource");
	cookies[14] = xcb_query_extension_unchecked(conn, strlen("MIT-SCREEN-SAVER"), "MIT-SCREEN-SAVER");
	cookies[15] = xcb_query_extension_unchecked(conn, strlen("SHAPE"), "SHAPE");
	cookies[16] = xcb_query_extension_unchecked(conn, strlen("MIT-SHM"), "MIT-SHM");
	cookies[17] = xcb_query_extension_unchecked(conn, strlen("SYNC"), "SYNC");
	cookies[18] = xcb_query_extension_unchecked(conn, strlen("XC-MISC"), "XC-MISC");
	cookies[19] = xcb_query_extension_unchecked(conn, strlen("XEVIE"), "XEVIE");
	cookies[20] = xcb_query_extension_unchecked(conn, strlen("XFree86-DRI"), "XFree86-DRI");
	cookies[21] = xcb_query_extension_unchecked(conn, strlen("XFree86-VidModeExtension"), "XFree86-VidModeExtension");
	cookies[22] = xcb_query_extension_unchecked(conn, strlen("XFIXES"), "XFIXES");
	cookies[23] = xcb_query_extension_unchecked(conn, strlen("XINERAMA"), "XINERAMA");
	cookies[24] = xcb_query_extension_unchecked(conn, strlen("XInputExtension"), "XInputExtension");
	cookies[25] = xcb_query_extension_unchecked(conn, strlen("XKEYBOARD"), "XKEYBOARD");
	cookies[26] = xcb_query_extension_unchecked(conn, strlen("XpExtension"), "XpExtension");
	cookies[27] = xcb_query_extension_unchecked(conn, strlen("SELinux"), "SELinux");
	...
	cookies[30] = xcb_query_extension_unchecked(conn, strlen("XVideo-MotionCompensation"), "XVideo-MotionCompensation");
	...
	ret |= register_extension(ctx, conn, cookies[7], &extension_GenericEvent_info);
	...
	ret |= register_extension(ctx, conn, cookies[14], &extension_ScreenSaver_info);
	...
	ret |= register_extension(ctx, conn, cookies[21], &extension_XF86VidMode_info);
	...
	ret |= register_extension(ctx, conn, cookies[30], &extension_XvMC_info);
	return ret;
}
